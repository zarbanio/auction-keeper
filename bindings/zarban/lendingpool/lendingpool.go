...
//
// Solidity: function initReserve(address asset, address zTokenAddress, address stableDebtAddress, address variableDebtAddress, address interestRateStrategyAddress) returns()
func (_Lendingpool *LendingpoolTransactor) InitReserve(opts *bind.TransactOpts, asset common.Address, zTokenAddress common.Address, stableDebtAddress common.Address, variableDebtAddress common.Address, interestRateStrategyAddress common.Address) (*types.Transaction, error) {
	return _Lendingpool.contract.Transact(opts, "initReserve", asset, zTokenAddress, stableDebtAddress, variableDebtAddress, interestRateStrategyAddress)
}

// InitReserve is a paid mutator transaction binding the contract method 0x7a708e92.
//
// Solidity: function initReserve(address asset, address zTokenAddress, address stableDebtAddress, address variableDebtAddress, address interestRateStrategyAddress) returns()
func (_Lendingpool *LendingpoolSession) InitReserve(asset common.Address, zTokenAddress common.Address, stableDebtAddress common.Address, variableDebtAddress common.Address, interestRateStrategyAddress common.Address) (*types.Transaction, error) {
	return _Lendingpool.Contract.InitReserve(&_Lendingpool.TransactOpts, asset, zTokenAddress, stableDebtAddress, variableDebtAddress, interestRateStrategyAddress)
}

// InitReserve is a paid mutator transaction binding the contract method 0x7a708e92.
//
// Solidity: function initReserve(address asset, address zTokenAddress, address stableDebtAddress, address variableDebtAddress, address interestRateStrategyAddress) returns()
func (_Lendingpool *LendingpoolTransactorSession) InitReserve(asset common.Address, zTokenAddress common.Address, stableDebtAddress common.Address, variableDebtAddress common.Address, interestRateStrategyAddress common.Address) (*types.Transaction, error) {
	return _Lendingpool.Contract.InitReserve(&_Lendingpool.TransactOpts, asset, zTokenAddress, stableDebtAddress, variableDebtAddress, interestRateStrategyAddress)
}
...
//
// Solidity: function liquidationCall(address collateralAsset, address debtAsset, address user, uint256 debtToCover, bool receiveZToken) returns()
func (_Lendingpool *LendingpoolTransactor) LiquidationCall(opts *bind.TransactOpts, collateralAsset common.Address, debtAsset common.Address, user common.Address, debtToCover *big.Int, receiveZToken bool) (*types.Transaction, error) {
	return _Lendingpool.contract.Transact(opts, "liquidationCall", collateralAsset, debtAsset, user, debtToCover, receiveZToken)
}

// LiquidationCall is a paid mutator transaction binding the contract method 0x00a718a9.
//
// Solidity: function liquidationCall(address collateralAsset, address debtAsset, address user, uint256 debtToCover, bool receiveZToken) returns()
func (_Lendingpool *LendingpoolSession) LiquidationCall(collateralAsset common.Address, debtAsset common.Address, user common.Address, debtToCover *big.Int, receiveZToken bool) (*types.Transaction, error) {
	return _Lendingpool.Contract.LiquidationCall(&_Lendingpool.TransactOpts, collateralAsset, debtAsset, user, debtToCover, receiveZToken)
}

// LiquidationCall is a paid mutator transaction binding the contract method 0x00a718a9.
//
// Solidity: function liquidationCall(address collateralAsset, address debtAsset, address user, uint256 debtToCover, bool receiveZToken) returns()
func (_Lendingpool *LendingpoolTransactorSession) LiquidationCall(collateralAsset common.Address, debtAsset common.Address, user common.Address, debtToCover *big.Int, receiveZToken bool) (*types.Transaction, error) {
	return _Lendingpool.Contract.LiquidationCall(&_Lendingpool.TransactOpts, collateralAsset, debtAsset, user, debtToCover, receiveZToken)
}
...
//
// Solidity: event LiquidationCall(address indexed collateralAsset, address indexed debtAsset, address indexed user, uint256 debtToCover, uint256 liquidatedCollateralAmount, address liquidator, bool receiveZToken)
