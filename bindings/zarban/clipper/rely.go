...
type RelyHandler struct {
	addr string
	binding  *Clipper
	callback events.CallbackFn[ClipperRely]
}
...
func NewRelyHandler(addr common.Address, eth *ethclient.Client, callback events.CallbackFn[ClipperRely]) events.Handler {
