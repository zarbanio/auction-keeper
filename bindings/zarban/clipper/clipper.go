...
//
// Solidity: function sales(uint256 ) view returns(uint256 pos, uint256 tab, uint256 lot, address usr, uint96 tic, uint256 top)
func (_Clipper *ClipperCaller) Sales(opts *bind.CallOpts, arg0 *big.Int) (struct {
	Pos *big.Int
	Tab *big.Int
	Lot *big.Int
	Usr common.Address
	...
	var out []interface{}
	err := _Clipper.contract.Call(opts, &out, "sales", arg0)
	...
	outstruct.Tab = *abi.ConvertType(out[1], new(*big.Int)).(**big.Int)
	outstruct.Lot = *abi.ConvertType(out[2], new(*big.Int)).(**big.Int)
	outstruct.Usr = *abi.ConvertType(out[3], new(common.Address)).(*common.Address)
	outstruct.Tic = *abi.ConvertType(out[4], new(*big.Int)).(**big.Int)
	outstruct.Top = *abi.ConvertType(out[5], new(*big.Int)).(**big.Int)
...
//
// Solidity: function sales(uint256 ) view returns(uint256 pos, uint256 tab, uint256 lot, address usr, uint96 tic, uint256 top)
func (_Clipper *ClipperSession) Sales(arg0 *big.Int) (struct {
	Pos *big.Int
	Tab *big.Int
	Lot *big.Int
	Usr common.Address
	...
	return _Clipper.Contract.Sales(&_Clipper.CallOpts, arg0)
}

// Sales is a free data retrieval call binding the contract method 0xb5f522f7.
//
// Solidity: function sales(uint256 ) view returns(uint256 pos, uint256 tab, uint256 lot, address usr, uint96 tic, uint256 top)
func (_Clipper *ClipperCallerSession) Sales(arg0 *big.Int) (struct {
	Pos *big.Int
	Tab *big.Int
	Lot *big.Int
	Usr common.Address
